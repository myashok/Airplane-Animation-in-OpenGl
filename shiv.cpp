...
void myinit(void)
{
    ...
    glColor3f(0.623529 +w, 0.623529+w, 0.372549+w);
    char *a=" CLICK TO CONTINUE";
    ...
    glColor3f(0.623529 +w, 0.623529+w, 0.372549+w);
    char *b="ADESH AKANSHU AISHWARY  SHIV";
    ...
    glRasterPos2f(150+325+10,500+y);
    for(int i = 0; s[i] !='\0'; i++)
